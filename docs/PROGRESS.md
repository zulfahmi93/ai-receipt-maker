...
Last verified: 2026-05-08 (Phase 3c sub-cluster B close — characterization tests pin `theme.highlightColor` → TOTAL bar fill and paper-paint layering invariant; Build 0/0; Core 76/76; Contracts 7/7).

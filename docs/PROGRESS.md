...
Last verified: 2026-05-08 (Phase 3e close — `ReceiptGenerator` façade + `ReceiptValidationException` + Save APIs + determinism + golden gate; Build 0/0; Core 108/108 passed + 2 skipped (Linux-only goldens); Contracts 7/7. Goldens deferred per divergence #23.).
